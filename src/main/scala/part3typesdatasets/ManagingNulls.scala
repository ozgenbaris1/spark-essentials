...
// select the first non-null value
  ...
  moviesDF
    .selectExpr(
      ...
      "nullif(Rotten_Tomatoes_Rating, IMDB_Rating * 10) as nullif", // returns null if the two values are EQUALi else first value
      "nvl2(Rotten_Tomatoes_Rating, IMDB_Rating * 10, 0.0) as nvl2" // if (first != null) return second else third
